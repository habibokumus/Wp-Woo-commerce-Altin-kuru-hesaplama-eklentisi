	...
	function woocommence_altin_fiyati_fields() {
		...
		?>		<?php $habibokm = file_get_contents ("https://finans.truncgil.com/today.json");
			...
			<table class="form-table widefat">
				...
				<tr valign="top">
					<th scope="row" style="padding-left: 1em;"><label for="woocommence_altin_fiyati_options_24">24k</label></th>
					<td>
				...
				<tr valign="top" class="alternate">
					<th scope="row" style="padding-left: 1em;"><label for="woocommence_altin_fiyati_options_22">22k</label></th>
					<td>
				...
				<tr valign="top">
					<th scope="row" style="padding-left: 1em;"><label for="woocommence_altin_fiyati_options_18">18k</label></th>
					<td>
				<?php
				...
				<tr valign="top" class="alternate">
					<th scope="row" style="padding-left: 1em;"><label for="woocommence_altin_fiyati_options_14">14k</label></th>
					<td>
				<?php
